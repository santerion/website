...
export function Hero() {
  return (
    <div className="relative w-full min-h-[calc(100vh-72px)] flex items-center justify-center">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image 
          src={getPublicPath("/bg_violet3.jpg")}
        ...
        <div className="absolute inset-0 bg-black/5 backdrop-brightness-160 backdrop-saturate-80" />
      </div>
      
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-5xl mx-auto text-white">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-12 drop-shadow-md mt-[-172]">
